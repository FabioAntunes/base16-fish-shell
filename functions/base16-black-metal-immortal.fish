...
function base16-black-metal-immortal -d "base16 Black Metal (Immortal) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "7799bb" green
        set -gx fish_color_redirection "556677" yellow
