...
function base16-black-metal-venom -d "base16 Black Metal (Venom) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "f8f7f2" green
        set -gx fish_color_redirection "79241f" yellow
