...
function base16-gruvbox-material-light-medium -d "base16 Gruvbox Material Light, Medium theme"
    ...
    __base16_fish_shell_create_vimrc_background gruvbox-material-light-medium
    set -U base16_fish_theme gruvbox-material-light-medium
