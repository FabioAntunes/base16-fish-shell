...
function base16-atelier-estuary-light -d "base16 Atelier Estuary Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "302f27" cyan
        set -gx fish_color_comment "878573" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "5f5e4e" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "5f5e4e" white --bold --underline
        set -gx fish_pager_color_progress "22221b" brwhite --background=cyan
    end
