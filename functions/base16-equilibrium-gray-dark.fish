...
function base16-equilibrium-gray-dark -d "base16 Equilibrium Gray Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "c6c6c6" cyan
        set -gx fish_color_comment "777777" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "ababab" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "ababab" white --bold --underline
        set -gx fish_pager_color_progress "e2e2e2" brwhite --background=cyan
    end
