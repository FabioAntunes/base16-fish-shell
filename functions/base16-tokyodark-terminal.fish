...
function base16-tokyodark-terminal -d "base16 Tokyodark Terminal theme"
    ...
    set color06 "38/a8/9d" # Base 0C - Cyan
    set color07 "a0/a8/cd" # Base 05 - White
    set color08 "28/2c/34" # Base 03 - Bright Black
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_end "38a89d" cyan
        set -gx fish_color_error "ee6d85" red
        set -gx fish_color_param "a0a8cd" cyan
        set -gx fish_color_comment "282c34" brblack
        ...
        set -gx fish_color_operator "38a89d" cyan
        set -gx fish_color_escape "38a89d" cyan
        set -gx fish_color_cwd "95c561" green
        set -gx fish_color_cwd_root "ee6d85" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "282c34" brblack
        ...
        set -gx fish_pager_color_progress "a0a8cd" brwhite --background=cyan
    end

    __base16_fish_shell_set_background "11" "12" "1d"
    __base16_fish_shell_create_vimrc_background tokyodark-terminal
    set -U base16_fish_theme tokyodark-terminal
