...
function base16-windows-nt -d "base16 Windows NT theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "00ff00" green
        set -gx fish_color_redirection "ffff00" yellow
