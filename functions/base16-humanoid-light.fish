...
function base16-humanoid-light -d "base16 Humanoid light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "0082c9" blue
        set -gx fish_color_quote "388e3c" green
        set -gx fish_color_redirection "ffb627" yellow
        set -gx fish_color_end "008e8e" cyan
        set -gx fish_color_error "b0151a" red
        set -gx fish_color_param "2f3337" cyan
        set -gx fish_color_comment "c0c0bd" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "232629" white --bold --background=brblack
        set -gx fish_color_search_match "ffb627" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "008e8e" cyan
        set -gx fish_color_escape "008e8e" cyan
        set -gx fish_color_cwd "388e3c" green
        set -gx fish_color_cwd_root "b0151a" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "c0c0bd" brblack
        set -gx fish_color_user "388e3c" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "ffb627" yellow
        set -gx fish_pager_color_prefix "232629" white --bold --underline
        set -gx fish_pager_color_progress "070708" brwhite --background=cyan
    end
