...
function base16-edge-dark -d "base16 Edge Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "73b3e7" blue
        set -gx fish_color_quote "a1bf78" green
        set -gx fish_color_redirection "dbb774" yellow
        set -gx fish_color_end "5ebaa5" cyan
        set -gx fish_color_error "e77171" red
        set -gx fish_color_param "d390e7" cyan
        set -gx fish_color_comment "3e4249" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "b7bec9" white --bold --background=brblack
        set -gx fish_color_search_match "dbb774" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "5ebaa5" cyan
        set -gx fish_color_escape "5ebaa5" cyan
        set -gx fish_color_cwd "a1bf78" green
        set -gx fish_color_cwd_root "e77171" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "3e4249" brblack
        set -gx fish_color_user "a1bf78" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "dbb774" yellow
        set -gx fish_pager_color_prefix "b7bec9" white --bold --underline
        set -gx fish_pager_color_progress "3e4249" brwhite --background=cyan
    end
