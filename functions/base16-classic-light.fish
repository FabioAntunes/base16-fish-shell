...
function base16-classic-light -d "base16 Classic Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "202020" cyan
        set -gx fish_color_comment "b0b0b0" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "303030" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "303030" white --bold --underline
        set -gx fish_pager_color_progress "151515" brwhite --background=cyan
    end
