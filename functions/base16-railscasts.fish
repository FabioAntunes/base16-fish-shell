...
function base16-railscasts -d "base16 Railscasts theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "6d9cbe" blue
        set -gx fish_color_quote "a5c261" green
        set -gx fish_color_redirection "ffc66d" yellow
        set -gx fish_color_end "519f50" cyan
        set -gx fish_color_error "da4939" red
        set -gx fish_color_param "f4f1ed" cyan
        set -gx fish_color_comment "5a647e" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "e6e1dc" white --bold --background=brblack
        set -gx fish_color_search_match "ffc66d" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "519f50" cyan
        set -gx fish_color_escape "519f50" cyan
        set -gx fish_color_cwd "a5c261" green
        set -gx fish_color_cwd_root "da4939" red
        ...
        set -gx fish_pager_color_prefix "e6e1dc" white --bold --underline
        set -gx fish_pager_color_progress "f9f7f3" brwhite --background=cyan
    end
