...
function base16-darkviolet -d "base16 Dark Violet theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "4136d9" blue
        set -gx fish_color_quote "4595e6" green
        set -gx fish_color_redirection "f29df2" yellow
        set -gx fish_color_end "40dfff" cyan
        set -gx fish_color_error "a82ee6" red
        set -gx fish_color_param "9045e6" cyan
        set -gx fish_color_comment "593380" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "b08ae6" white --bold --background=brblack
        set -gx fish_color_search_match "f29df2" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "40dfff" cyan
        set -gx fish_color_escape "40dfff" cyan
        set -gx fish_color_cwd "4595e6" green
        set -gx fish_color_cwd_root "a82ee6" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "593380" brblack
        set -gx fish_color_user "4595e6" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "f29df2" yellow
        set -gx fish_pager_color_prefix "b08ae6" white --bold --underline
        set -gx fish_pager_color_progress "a366ff" brwhite --background=cyan
    end
