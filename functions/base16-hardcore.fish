...
function base16-hardcore -d "base16 Hardcore theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_redirection "e6db74" yellow
        set -gx fish_color_end "708387" cyan
        set -gx fish_color_error "f92672" red
        set -gx fish_color_param "e5e5e5" cyan
        set -gx fish_color_comment "4a4a4a" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "cdcdcd" white --bold --background=brblack
        set -gx fish_color_search_match "e6db74" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "708387" cyan
        set -gx fish_color_escape "708387" cyan
        ...
        set -gx fish_pager_color_prefix "cdcdcd" white --bold --underline
