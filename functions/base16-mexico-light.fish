...
function base16-mexico-light -d "base16 Mexico Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "538947" green
        set -gx fish_color_redirection "f79a0e" yellow
        set -gx fish_color_end "4b8093" cyan
        ...
        set -gx fish_color_search_match "f79a0e" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "4b8093" cyan
        set -gx fish_color_escape "4b8093" cyan
        set -gx fish_color_cwd "538947" green
        set -gx fish_color_cwd_root "ab4642" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "b8b8b8" brblack
        set -gx fish_color_user "538947" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "f79a0e" yellow
