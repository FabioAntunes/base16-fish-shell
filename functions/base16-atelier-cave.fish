...
function base16-atelier-cave -d "base16 Atelier Cave theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "e2dfe7" cyan
        set -gx fish_color_comment "655f6d" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "8b8792" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "8b8792" white --bold --underline
        set -gx fish_pager_color_progress "efecf4" brwhite --background=cyan
    end
