...
function base16-brogrammer -d "base16 Brogrammer theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "5350b9" blue
        set -gx fish_color_quote "f3bd09" green
        set -gx fish_color_redirection "1dd361" yellow
        set -gx fish_color_end "1081d6" cyan
        set -gx fish_color_error "d6dbe5" red
        set -gx fish_color_param "1081d6" cyan
        set -gx fish_color_comment "ecba0f" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "4e5ab7" white --bold --background=brblack
        set -gx fish_color_search_match "1dd361" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "1081d6" cyan
        set -gx fish_color_escape "1081d6" cyan
        set -gx fish_color_cwd "f3bd09" green
        set -gx fish_color_cwd_root "d6dbe5" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "ecba0f" brblack
        set -gx fish_color_user "f3bd09" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "1dd361" yellow
        set -gx fish_pager_color_prefix "4e5ab7" white --bold --underline
        set -gx fish_pager_color_progress "d6dbe5" brwhite --background=cyan
    end
