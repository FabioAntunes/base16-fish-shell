...
function base16-tube -d "base16 London Tube theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "009ddc" blue
        set -gx fish_color_quote "00853e" green
        set -gx fish_color_redirection "ffd204" yellow
        set -gx fish_color_end "85cebc" cyan
        set -gx fish_color_error "ee2e24" red
        set -gx fish_color_param "e7e7e8" cyan
        set -gx fish_color_comment "737171" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "d9d8d8" white --bold --background=brblack
        set -gx fish_color_search_match "ffd204" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "85cebc" cyan
        set -gx fish_color_escape "85cebc" cyan
        set -gx fish_color_cwd "00853e" green
        set -gx fish_color_cwd_root "ee2e24" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "737171" brblack
        set -gx fish_color_user "00853e" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "ffd204" yellow
        set -gx fish_pager_color_prefix "d9d8d8" white --bold --underline
