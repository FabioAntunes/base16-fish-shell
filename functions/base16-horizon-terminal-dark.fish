...
function base16-horizon-terminal-dark -d "base16 Horizon Terminal Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "26bbd9" blue
        set -gx fish_color_quote "29d398" green
        set -gx fish_color_redirection "fac29a" yellow
        set -gx fish_color_end "59e1e3" cyan
        set -gx fish_color_error "e95678" red
        ...
        set -gx fish_color_search_match "fac29a" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "59e1e3" cyan
        set -gx fish_color_escape "59e1e3" cyan
        set -gx fish_color_cwd "29d398" green
        set -gx fish_color_cwd_root "e95678" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "6f6f70" brblack
        set -gx fish_color_user "29d398" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "fac29a" yellow
