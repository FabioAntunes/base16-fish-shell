...
function base16-black-metal-gorgoroth -d "base16 Black Metal (Gorgoroth) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "9b8d7f" green
        set -gx fish_color_redirection "8c7f70" yellow
