...
function base16-gruvbox-material-dark-soft -d "base16 Gruvbox Material Dark, Soft theme"
    ...
    set color08 "7c/6f/64" # Base 03 - Bright Black
    ...
    if test -n "$ITERM_SESSION_ID"
        ...
        __put_template_custom Pj 5a524c # selection color
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_comment "7c6f64" brblack
        ...
        set -gx fish_color_autosuggestion "7c6f64" brblack
    ...
    __base16_fish_shell_create_vimrc_background gruvbox-material-dark-soft
    set -U base16_fish_theme gruvbox-material-dark-soft
