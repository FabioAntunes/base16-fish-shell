...
function base16-porple -d "base16 Porple theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "8485ce" blue
        set -gx fish_color_quote "95c76f" green
        set -gx fish_color_redirection "efa16b" yellow
        set -gx fish_color_end "64878f" cyan
        set -gx fish_color_error "f84547" red
        set -gx fish_color_param "e8e8e8" cyan
        set -gx fish_color_comment "65568a" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "d8d8d8" white --bold --background=brblack
        set -gx fish_color_search_match "efa16b" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "64878f" cyan
        set -gx fish_color_escape "64878f" cyan
        set -gx fish_color_cwd "95c76f" green
        set -gx fish_color_cwd_root "f84547" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "65568a" brblack
        set -gx fish_color_user "95c76f" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "efa16b" yellow
        set -gx fish_pager_color_prefix "d8d8d8" white --bold --underline
