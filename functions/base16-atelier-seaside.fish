...
function base16-atelier-seaside -d "base16 Atelier Seaside theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "cfe8cf" cyan
        set -gx fish_color_comment "687d68" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "8ca68c" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "8ca68c" white --bold --underline
        set -gx fish_pager_color_progress "f4fbf4" brwhite --background=cyan
    end
