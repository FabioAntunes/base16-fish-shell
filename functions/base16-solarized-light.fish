...
function base16-solarized-light -d "base16 Solarized Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "073642" cyan
        set -gx fish_color_comment "839496" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "586e75" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "586e75" white --bold --underline
        set -gx fish_pager_color_progress "002b36" brwhite --background=cyan
    end
