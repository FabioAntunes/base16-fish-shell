...
function base16-equilibrium-light -d "base16 Equilibrium Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "2c3138" cyan
        set -gx fish_color_comment "73777f" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "43474e" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "43474e" white --bold --underline
        set -gx fish_pager_color_progress "181c22" brwhite --background=cyan
    end
