...
function base16-atelier-dune -d "base16 Atelier Dune theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "e8e4cf" cyan
        set -gx fish_color_comment "7d7a68" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "a6a28c" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "a6a28c" white --bold --underline
        set -gx fish_pager_color_progress "fefbec" brwhite --background=cyan
    end
