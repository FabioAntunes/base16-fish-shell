...
function base16-rose-pine -d "base16 Rosé Pine theme"
    ...
    if test -n "$ITERM_SESSION_ID"
        ...
        __put_template_custom Ph 191724 # background
        __put_template_custom Pi e0def4 # bold color
        __put_template_custom Pj 26233a # selection color
        __put_template_custom Pk e0def4 # selected text color
        __put_template_custom Pl e0def4 # cursor
        __put_template_custom Pm 191724 # cursor text
    ...
    __base16_fish_shell_create_vimrc_background rose-pine
    set -U base16_fish_theme rose-pine
