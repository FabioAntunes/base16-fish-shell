...
function base16-unikitty-light -d "base16 Unikitty Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "775dff" blue
        ...
        set -gx fish_color_param "4f4b51" cyan
        set -gx fish_color_comment "a7a5a8" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "6c696e" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "6c696e" white --bold --underline
        set -gx fish_pager_color_progress "322d34" brwhite --background=cyan
    end
