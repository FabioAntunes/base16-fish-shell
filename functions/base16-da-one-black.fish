...
function base16-da-one-black -d "base16 Da One Black theme"
    ...
    set color08 "88/88/88" # Base 03 - Bright Black
    ...
    if test -n "$ITERM_SESSION_ID"
        ...
        __put_template_custom Pj 585858 # selection color
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_comment "888888" brblack
        ...
        set -gx fish_color_autosuggestion "888888" brblack
    ...
    __base16_fish_shell_create_vimrc_background da-one-black
    set -U base16_fish_theme da-one-black
