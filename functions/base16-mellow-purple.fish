...
function base16-mellow-purple -d "base16 Mellow Purple theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "550068" blue
        set -gx fish_color_quote "05cb0d" green
        set -gx fish_color_redirection "955ae7" yellow
        set -gx fish_color_end "b900b1" cyan
        set -gx fish_color_error "00d9e9" red
        set -gx fish_color_param "ffeeff" cyan
        set -gx fish_color_comment "320f55" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "ffeeff" white --bold --background=brblack
        set -gx fish_color_search_match "955ae7" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "b900b1" cyan
        set -gx fish_color_escape "b900b1" cyan
        set -gx fish_color_cwd "05cb0d" green
        set -gx fish_color_cwd_root "00d9e9" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "320f55" brblack
        set -gx fish_color_user "05cb0d" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "955ae7" yellow
        set -gx fish_pager_color_prefix "ffeeff" white --bold --underline
        set -gx fish_pager_color_progress "f8c0ff" brwhite --background=cyan
    end
