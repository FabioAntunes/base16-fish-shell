...
function base16-equilibrium-dark -d "base16 Equilibrium Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "008dd1" blue
        set -gx fish_color_quote "7f8b00" green
        set -gx fish_color_redirection "bb8801" yellow
        set -gx fish_color_end "00948b" cyan
        set -gx fish_color_error "f04339" red
        set -gx fish_color_param "cac6bd" cyan
        set -gx fish_color_comment "7b776e" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "afaba2" white --bold --background=brblack
        set -gx fish_color_search_match "bb8801" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "00948b" cyan
        set -gx fish_color_escape "00948b" cyan
        set -gx fish_color_cwd "7f8b00" green
        set -gx fish_color_cwd_root "f04339" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "7b776e" brblack
        set -gx fish_color_user "7f8b00" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "bb8801" yellow
        set -gx fish_pager_color_prefix "afaba2" white --bold --underline
        set -gx fish_pager_color_progress "e7e2d9" brwhite --background=cyan
    end
