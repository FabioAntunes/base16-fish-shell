...
function base16-gruvbox-material-dark-hard -d "base16 Gruvbox Material Dark, Hard theme"
    ...
    set color_background "20/20/20" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
        ...
        __put_template_custom Ph 202020 # background
        ...
        __put_template_custom Pm 202020 # cursor text
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_comment "5a524c" brblack
        ...
        set -gx fish_color_autosuggestion "5a524c" brblack
    ...
    __base16_fish_shell_set_background "20" "20" "20"
    __base16_fish_shell_create_vimrc_background gruvbox-material-dark-hard
    set -U base16_fish_theme gruvbox-material-dark-hard
