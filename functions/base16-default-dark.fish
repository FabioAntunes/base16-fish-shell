...
function base16-default-dark -d "base16 Default Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "7cafc2" blue
        set -gx fish_color_quote "a1b56c" green
        set -gx fish_color_redirection "f7ca88" yellow
        set -gx fish_color_end "86c1b9" cyan
        set -gx fish_color_error "ab4642" red
        ...
        set -gx fish_color_search_match "f7ca88" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "86c1b9" cyan
        set -gx fish_color_escape "86c1b9" cyan
        set -gx fish_color_cwd "a1b56c" green
        set -gx fish_color_cwd_root "ab4642" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "585858" brblack
        set -gx fish_color_user "a1b56c" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "f7ca88" yellow
