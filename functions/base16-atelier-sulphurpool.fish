...
function base16-atelier-sulphurpool -d "base16 Atelier Sulphurpool theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "dfe2f1" cyan
        set -gx fish_color_comment "6b7394" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "979db4" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "979db4" white --bold --underline
        set -gx fish_pager_color_progress "f5f7ff" brwhite --background=cyan
    end
