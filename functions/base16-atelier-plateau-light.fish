...
function base16-atelier-plateau-light -d "base16 Atelier Plateau Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "292424" cyan
        set -gx fish_color_comment "7e7777" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "585050" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "585050" white --bold --underline
        set -gx fish_pager_color_progress "1b1818" brwhite --background=cyan
    end
