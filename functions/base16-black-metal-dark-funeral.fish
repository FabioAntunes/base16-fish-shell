...
function base16-black-metal-dark-funeral -d "base16 Black Metal (Dark Funeral) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "d0dfee" green
        set -gx fish_color_redirection "5f81a5" yellow
