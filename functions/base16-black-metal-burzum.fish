...
function base16-black-metal-burzum -d "base16 Black Metal (Burzum) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "ddeecc" green
        set -gx fish_color_redirection "99bbaa" yellow
