...
function base16-chalk -d "base16 Chalk theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "6fc2ef" blue
        set -gx fish_color_quote "acc267" green
        set -gx fish_color_redirection "ddb26f" yellow
        set -gx fish_color_end "12cfc0" cyan
        set -gx fish_color_error "fb9fb1" red
        ...
        set -gx fish_color_search_match "ddb26f" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "12cfc0" cyan
        set -gx fish_color_escape "12cfc0" cyan
        set -gx fish_color_cwd "acc267" green
        set -gx fish_color_cwd_root "fb9fb1" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "505050" brblack
        set -gx fish_color_user "acc267" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "ddb26f" yellow
