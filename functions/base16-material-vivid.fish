...
function base16-material-vivid -d "base16 Material Vivid theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "2196f3" blue
        set -gx fish_color_quote "00e676" green
        set -gx fish_color_redirection "ffeb3b" yellow
        set -gx fish_color_end "00bcd4" cyan
        set -gx fish_color_error "f44336" red
        set -gx fish_color_param "9e9e9e" cyan
        set -gx fish_color_comment "44464d" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "80868b" white --bold --background=brblack
        set -gx fish_color_search_match "ffeb3b" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "00bcd4" cyan
        set -gx fish_color_escape "00bcd4" cyan
        set -gx fish_color_cwd "00e676" green
        set -gx fish_color_cwd_root "f44336" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "44464d" brblack
        set -gx fish_color_user "00e676" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "ffeb3b" yellow
        set -gx fish_pager_color_prefix "80868b" white --bold --underline
