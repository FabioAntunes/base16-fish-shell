...
function base16-black-metal-nile -d "base16 Black Metal (Nile) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "aa9988" green
        set -gx fish_color_redirection "777755" yellow
