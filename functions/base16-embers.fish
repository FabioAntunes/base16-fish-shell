...
function base16-embers -d "base16 Embers theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "6d5782" blue
        set -gx fish_color_quote "57826d" green
        set -gx fish_color_redirection "6d8257" yellow
        set -gx fish_color_end "576d82" cyan
        set -gx fish_color_error "826d57" red
        set -gx fish_color_param "beb6ae" cyan
        set -gx fish_color_comment "5a5047" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "a39a90" white --bold --background=brblack
        set -gx fish_color_search_match "6d8257" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "576d82" cyan
        set -gx fish_color_escape "576d82" cyan
        set -gx fish_color_cwd "57826d" green
        set -gx fish_color_cwd_root "826d57" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "5a5047" brblack
        set -gx fish_color_user "57826d" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "6d8257" yellow
        set -gx fish_pager_color_prefix "a39a90" white --bold --underline
        set -gx fish_pager_color_progress "dbd6d1" brwhite --background=cyan
    end
