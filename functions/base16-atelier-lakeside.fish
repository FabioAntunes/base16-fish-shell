...
function base16-atelier-lakeside -d "base16 Atelier Lakeside theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "c1e4f6" cyan
        set -gx fish_color_comment "5a7b8c" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "7ea2b4" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "7ea2b4" white --bold --underline
        set -gx fish_pager_color_progress "ebf8ff" brwhite --background=cyan
    end
