...
function base16-synth-midnight-dark -d "base16 Synth Midnight Terminal Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "cfd1d2" cyan
        set -gx fish_color_comment "474849" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "c1c3c4" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "c1c3c4" white --bold --underline
        set -gx fish_pager_color_progress "dddfe0" brwhite --background=cyan
    end
