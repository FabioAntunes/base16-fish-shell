...
function base16-black-metal-marduk -d "base16 Black Metal (Marduk) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "a5aaa7" green
        set -gx fish_color_redirection "626b67" yellow
