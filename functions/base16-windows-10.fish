...
function base16-windows-10 -d "base16 Windows 10 theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "3b78ff" blue
        set -gx fish_color_quote "16c60c" green
        set -gx fish_color_redirection "f9f1a5" yellow
        set -gx fish_color_end "61d6d6" cyan
        set -gx fish_color_error "e74856" red
        set -gx fish_color_param "dfdfdf" cyan
        set -gx fish_color_comment "767676" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "cccccc" white --bold --background=brblack
        set -gx fish_color_search_match "f9f1a5" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "61d6d6" cyan
        set -gx fish_color_escape "61d6d6" cyan
        set -gx fish_color_cwd "16c60c" green
        set -gx fish_color_cwd_root "e74856" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "767676" brblack
        set -gx fish_color_user "16c60c" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "f9f1a5" yellow
        set -gx fish_pager_color_prefix "cccccc" white --bold --underline
        set -gx fish_pager_color_progress "f2f2f2" brwhite --background=cyan
    end
