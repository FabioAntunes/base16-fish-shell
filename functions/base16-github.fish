...
function base16-github -d "base16 Github theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "795da3" blue
        set -gx fish_color_quote "183691" green
        set -gx fish_color_redirection "795da3" yellow
        set -gx fish_color_end "183691" cyan
        set -gx fish_color_error "ed6a43" red
        set -gx fish_color_param "ffffff" cyan
        set -gx fish_color_comment "969896" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "333333" white --bold --background=brblack
        set -gx fish_color_search_match "795da3" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "183691" cyan
        set -gx fish_color_escape "183691" cyan
        set -gx fish_color_cwd "183691" green
        set -gx fish_color_cwd_root "ed6a43" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "969896" brblack
        set -gx fish_color_user "183691" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "795da3" yellow
        set -gx fish_pager_color_prefix "333333" white --bold --underline
