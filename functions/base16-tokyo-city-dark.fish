...
function base16-tokyo-city-dark -d "base16 Tokyo City Dark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_redirection "b7c5d3" yellow
        ...
        set -gx fish_color_search_match "b7c5d3" bryellow --background=brblack
        ...
        set -gx fish_pager_color_description "b7c5d3" yellow
    ...
    set -U base16_fish_theme tokyo-city-dark
