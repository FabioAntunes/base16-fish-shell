...
function base16-tomorrow -d "base16 Tomorrow theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "4271ae" blue
        set -gx fish_color_quote "718c00" green
        set -gx fish_color_redirection "eab700" yellow
        set -gx fish_color_end "3e999f" cyan
        set -gx fish_color_error "c82829" red
        set -gx fish_color_param "282a2e" cyan
        set -gx fish_color_comment "8e908c" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "4d4d4c" white --bold --background=brblack
        set -gx fish_color_search_match "eab700" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "3e999f" cyan
        set -gx fish_color_escape "3e999f" cyan
        set -gx fish_color_cwd "718c00" green
        set -gx fish_color_cwd_root "c82829" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "8e908c" brblack
        set -gx fish_color_user "718c00" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "eab700" yellow
        set -gx fish_pager_color_prefix "4d4d4c" white --bold --underline
        set -gx fish_pager_color_progress "1d1f21" brwhite --background=cyan
    end
