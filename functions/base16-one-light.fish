...
function base16-one-light -d "base16 One Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "4078f2" blue
        set -gx fish_color_quote "50a14f" green
        set -gx fish_color_redirection "c18401" yellow
        set -gx fish_color_end "0184bc" cyan
        set -gx fish_color_error "ca1243" red
        set -gx fish_color_param "202227" cyan
        set -gx fish_color_comment "a0a1a7" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "383a42" white --bold --background=brblack
        set -gx fish_color_search_match "c18401" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "0184bc" cyan
        set -gx fish_color_escape "0184bc" cyan
        set -gx fish_color_cwd "50a14f" green
        set -gx fish_color_cwd_root "ca1243" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "a0a1a7" brblack
        set -gx fish_color_user "50a14f" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "c18401" yellow
        set -gx fish_pager_color_prefix "383a42" white --bold --underline
        set -gx fish_pager_color_progress "090a0b" brwhite --background=cyan
    end
