...
function base16-hopscotch -d "base16 Hopscotch theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "1290bf" blue
        set -gx fish_color_quote "8fc13e" green
        set -gx fish_color_redirection "fdcc59" yellow
        set -gx fish_color_end "149b93" cyan
        set -gx fish_color_error "dd464c" red
        set -gx fish_color_param "d5d3d5" cyan
        set -gx fish_color_comment "797379" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "b9b5b8" white --bold --background=brblack
        set -gx fish_color_search_match "fdcc59" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "149b93" cyan
        set -gx fish_color_escape "149b93" cyan
        set -gx fish_color_cwd "8fc13e" green
        set -gx fish_color_cwd_root "dd464c" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "797379" brblack
        set -gx fish_color_user "8fc13e" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "fdcc59" yellow
        set -gx fish_pager_color_prefix "b9b5b8" white --bold --underline
