...
function base16-atelier-heath-light -d "base16 Atelier Heath Light theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "292329" cyan
        set -gx fish_color_comment "9e8f9e" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "695d69" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "695d69" white --bold --underline
        set -gx fish_pager_color_progress "1b181b" brwhite --background=cyan
    end
