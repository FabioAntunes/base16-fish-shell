...
function base16-darkmoss -d "base16 darkmoss theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "498091" blue
        set -gx fish_color_quote "499180" green
        set -gx fish_color_redirection "fdb11f" yellow
        set -gx fish_color_end "66d9ef" cyan
        set -gx fish_color_error "ff4658" red
        set -gx fish_color_param "e3e3c8" cyan
        set -gx fish_color_comment "555e5f" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "c7c7a5" white --bold --background=brblack
        set -gx fish_color_search_match "fdb11f" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "66d9ef" cyan
        set -gx fish_color_escape "66d9ef" cyan
        set -gx fish_color_cwd "499180" green
        set -gx fish_color_cwd_root "ff4658" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "555e5f" brblack
        set -gx fish_color_user "499180" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "fdb11f" yellow
        set -gx fish_pager_color_prefix "c7c7a5" white --bold --underline
        set -gx fish_pager_color_progress "e1eaef" brwhite --background=cyan
    end
