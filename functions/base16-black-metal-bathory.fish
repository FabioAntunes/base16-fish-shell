...
function base16-black-metal-bathory -d "base16 Black Metal (Bathory) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "fbcb97" green
        set -gx fish_color_redirection "e78a53" yellow
