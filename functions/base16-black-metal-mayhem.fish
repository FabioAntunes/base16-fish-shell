...
function base16-black-metal-mayhem -d "base16 Black Metal (Mayhem) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "f3ecd4" green
        set -gx fish_color_redirection "eecc6c" yellow
