...
function base16-black-metal -d "base16 Black Metal theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_quote "dd9999" green
        set -gx fish_color_redirection "a06666" yellow
