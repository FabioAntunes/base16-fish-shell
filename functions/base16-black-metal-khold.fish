...
function base16-black-metal-khold -d "base16 Black Metal (Khold) theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "888888" blue
        set -gx fish_color_quote "eceee3" green
        set -gx fish_color_redirection "974b46" yellow
        set -gx fish_color_end "aaaaaa" cyan
        set -gx fish_color_error "5f8787" red
        set -gx fish_color_param "999999" cyan
        set -gx fish_color_comment "333333" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "c1c1c1" white --bold --background=brblack
        set -gx fish_color_search_match "974b46" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "aaaaaa" cyan
        set -gx fish_color_escape "aaaaaa" cyan
        set -gx fish_color_cwd "eceee3" green
        set -gx fish_color_cwd_root "5f8787" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "333333" brblack
        set -gx fish_color_user "eceee3" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "974b46" yellow
        set -gx fish_pager_color_prefix "c1c1c1" white --bold --underline
        set -gx fish_pager_color_progress "c1c1c1" brwhite --background=cyan
    end
