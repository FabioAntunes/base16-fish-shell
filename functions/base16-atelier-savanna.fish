...
function base16-atelier-savanna -d "base16 Atelier Savanna theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_param "dfe7e2" cyan
        set -gx fish_color_comment "5f6d64" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "87928a" white --bold --background=brblack
        ...
        set -gx fish_pager_color_prefix "87928a" white --bold --underline
        set -gx fish_pager_color_progress "ecf4ee" brwhite --background=cyan
    end
