...
function base16-onedark -d "base16 OneDark theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_end "56b6c2" cyan
        set -gx fish_color_error "e06c75" red
        set -gx fish_color_param "b6bdca" cyan
        set -gx fish_color_comment "545862" brblack
        ...
        set -gx fish_color_operator "56b6c2" cyan
        set -gx fish_color_escape "56b6c2" cyan
        set -gx fish_color_cwd "98c379" green
        set -gx fish_color_cwd_root "e06c75" red
