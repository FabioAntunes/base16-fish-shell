...
function base16-brewer -d "base16 Brewer theme"
    ...
    if test -z $base16_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_command "3182bd" blue
        set -gx fish_color_quote "31a354" green
        set -gx fish_color_redirection "dca060" yellow
        set -gx fish_color_end "80b1d3" cyan
        set -gx fish_color_error "e31a1c" red
        set -gx fish_color_param "dadbdc" cyan
        set -gx fish_color_comment "737475" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "b7b8b9" white --bold --background=brblack
        set -gx fish_color_search_match "dca060" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "80b1d3" cyan
        set -gx fish_color_escape "80b1d3" cyan
        set -gx fish_color_cwd "31a354" green
        set -gx fish_color_cwd_root "e31a1c" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "737475" brblack
        set -gx fish_color_user "31a354" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "dca060" yellow
        set -gx fish_pager_color_prefix "b7b8b9" white --bold --underline
        set -gx fish_pager_color_progress "fcfdfe" brwhite --background=cyan
    end
